				...
				<div class="col-lg-10 offset-lg-1">
					<div class="section_title text-center">
						<div align="center">
							...
							<?php 
								if (!empty($userinfo['avatarAdmin'])) {
								?>
								<img style="width: 150px; height: 150px; border-radius: 50%" src="admins/avatars/<?php echo $userinfo['avatarAdmin']; ?>">
								<?php
								}
							?>
							<p>Nom d'utilisateur : <span style="font-weight: bold;"><?= $userinfo['name']; ?></span></p>
							<p>Email : <span style="font-weight: bold;"><?= $userinfo['email']; ?></span></p>
							<?php
								if (isset($_SESSION['idAdmin']) AND $userinfo['idAdmin'] == $_SESSION['idAdmin']) {
							?>
							<p>
								<a href="modifyProfilAdmin.php">Modifier mes informations</a> -- 
								<a href="adminDeconnexion.php">Se déconnecter</a>
							</p>
							<?php
								}
							?>
