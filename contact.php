...
<div class="super_container">
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<div class="menu_extra">
			<div class="menu_phone"><span class="menu_title">téléphone:</span>(221) 78 155 64 94</div>
								...
								<div class="contact_about">
									...
									<div class="contact_about_text">
										<p>Pour plus de renseignements veuillez nous contectez sur lemail et les numeros ci-dessous,
											sinon trouvez-nous à notre résidence Espace Numerique Ouvert de Mbour(Eno).Il se trouve à Saly
											Aérodrom à trentes mètres du croisement de la route nationale n° 1 sur la route  du quartier
											Cité-enseignant. </p>
									</div>
								</div>
							</div>
